...
SolidityFunction.prototype.sendRawTransaction = function() {
    ...
    if (global.keyManager) {
        account = global.keyManager.accounts.find(function (account) {
            return account.address == payload.from;
        });
    }

    if ((!account) || (account && (!account.privateKey)) && global.web3) {
        account = global.web3.accounts.find(function (account) {
            return account.address == payload.from;
        });
    }
